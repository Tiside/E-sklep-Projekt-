    ...
    return(
        ...
        <div className="nav">
            ...
            <div className="nav-content">
                <div className="logo">
                    <a href="../layout.tsx"><Image src="/shoe-king-removebg-preview.png" alt="logo" width={200} height={200} /></a>
                </div>
                ...
                <div className="user-container">
                    ...
                    <div className="user">
                        <div className="user-pfp">
                            ...
                            <Link href="/Koszyk">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 cart">
